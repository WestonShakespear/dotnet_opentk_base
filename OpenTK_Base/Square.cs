    ...
    public class Square
    {
        ...
        public static void Subdivide(Square _root)
        {
            if (_root.Self == true)
            {
                ...
                _root.SubSquare[1].SetColor(_root.R + 0.1f, _root.G, _root.B, _root.A);

                _root.SubSquare[2] = new Square(bottom_right);
                _root.SubSquare[2].SetColor(_root.R, _root.G + 0.1f, _root.B, _root.A);

                _root.SubSquare[3] = new Square(bottom_left);
                _root.SubSquare[3].SetColor(_root.R, _root.G, _root.B + 0.1f, _root.A);
            }

            Console.WriteLine("subdivided");
